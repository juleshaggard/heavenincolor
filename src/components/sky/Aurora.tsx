...
export function Aurora() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <div
        className="aurora absolute -top-1/3 left-1/2 h-[120vh] w-[140vw] -translate-x-1/2 rounded-full opacity-[0.18] blur-3xl"
        style={{
          background:
      ...
      />
      <div
        className="aurora absolute bottom-[-30vh] left-[10%] h-[80vh] w-[80vw] rounded-full opacity-[0.12] blur-3xl"
        style={{
          background:
