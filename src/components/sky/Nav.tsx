...
export function Nav() {
  return (
    <header
      className="sticky top-0 z-40 border-b border-hairline backdrop-blur-xl"
      style={{
        background:
          "linear-gradient(180deg, hsl(var(--background) / 0.92), hsl(var(--background) / 0.6)), hsl(var(--sky-h) var(--sky-s) var(--sky-l) / 0.06)",
      }}
    >
      <div className="mx-auto flex h-14 max-w-[1400px] items-center justify-between px-6">
        <NavLink to="/" className="group flex items-baseline gap-2">
          <span className="font-display text-xl tracking-tight text-ink">Sky</span>
          <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-ink-faint">archive</span>
          <span
